    ...
    <div class="row">
      <div class="col-xs-12 col-lg-3">
        <h3 class="panel-title">
          ...
          &nbsp;عرض الاعلانات المخفية
        </h3>
      </div>
      <div class="col-xs-9 col-lg-4 no-padding">
        <div class="input-group">
          <input type="text" class="form-control input-sm" ng-model="searchHiddenName" ng-change="searchHiddenByName()" placeholder="بحث..." style="line-height:25px;">
      ...
      <div class="col-xs-10 col-lg-5 form-inline text-left">
        ...
        <a class="btn btn-danger btn-sm" ui-sref="adsDeleteList"><em class="fa fa-trash fa-fw"></em>&nbsp;الاعلانات المحذوفة</a>
